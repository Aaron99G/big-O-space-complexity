...
function getNumbersSquared2(numbers) {
    ...
    for (let i = 0; i < numbers.length; i++) {
        answers.push(Math.pow(numbers[i], 2))
    }
    return answers
}
...
// ANSWER: Both are linear because the space they take up will be determined by the size of the array, which will be the Alphabet
